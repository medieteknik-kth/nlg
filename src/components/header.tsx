    ...
    <header className={styles.container}>
      ...
      <nav>
        <ul>
          ...
          <li>
            <Link className={styles.navItem + " " + styles[getActiveClass(0)]} to="">Hem</Link>
          </li>
          <li>
            <Link className={styles.navItem + " " + getActiveClass(1)} to="">Timeline</Link>
          </li>
          <li>
            <Link className={styles.navItem + " " + getActiveClass(2)} to="">Kontakt</Link>
          </li>
          <li>
            <Link className={styles.navItem + " " + getActiveClass(3)} to="">Om oss</Link>
          </li>
        </ul>
      </nav>
    </header>
